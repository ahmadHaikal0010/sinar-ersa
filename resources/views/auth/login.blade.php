...
<head>
  ...
  <style>
    ...
    .food-icon:nth-child(2) { left: 50%; animation-delay: 2s; font-size: 105px; }
    .food-icon:nth-child(3) { left: 30%; animation-delay: 4s; font-size: 90px; }
    .food-icon:nth-child(4) { left: 75%; animation-delay: 6s; font-size: 110px; }
    .food-icon:nth-child(5) { left: 5%; animation-delay: 8s; font-size: 85px; }
    ...
    .btn-login {
      background-color: #b0763c; /* coklat lembut */
      color: white;
      border: none;
      border-radius: 10px;
      padding: 12px;
  ...
  <div class="login-container">
    ...
    <div class="login-form">
      ...
      <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mb-3">
          <label>Email</label>
          <input type="email" name="email" value="{{ old('email') }}" class="form-control" placeholder="johnsandoe@mail.com" required autofocus>
          @error('email')
