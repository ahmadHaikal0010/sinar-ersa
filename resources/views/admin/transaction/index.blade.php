            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-gray-50/50 border-b border-gray-100">
                        <th class="px-8 py-6 text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Menu & Jumlah</th>
                        <th class="px-6 py-6 text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Total Harga</th>
                        <th class="px-6 py-6 text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Metode</th>
                        <th class="px-6 py-6 text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Deskripsi</th>
                        ...
                        <tr class="hover:bg-[#FFFBF5]/50 transition-colors group">
                            ...
                            <td class="px-8 py-5">
                                <div class="flex flex-col">
                                    <span class="font-bold text-[#4A3728] text-base">{{ $transaction->menu->nama }}</span>
                            ...
                            <td class="px-6 py-5">
                                <div class="flex justify-center items-center gap-2">
                                    ...
                                    <form action="{{ route('admin.transaction.destroy', $transaction) }}" method="POST" onsubmit="return confirm('Hapus transaksi ini?')">
                                        @csrf @method('DELETE')
                                        <button type="submit" class="w-10 h-10 flex items-center justify-center rounded-xl bg-gray-50 text-red-300 hover:bg-red-500 hover:text-white transition-all shadow-sm">
