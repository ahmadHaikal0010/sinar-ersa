    ...
    <div class="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        <div class="space-y-8">
            ...
            <p class="text-gray-500 text-lg md:text-xl leading-relaxed max-w-md font-light">
                Menyajikan kehangatan masakan rumah dalam setiap gigitan. Dari <span class="font-semibold text-[#4A3728]">Oleh-oleh khas</span> hingga <span class="font-semibold text-[#4A3728]">Sarapan Pagi</span> yang menggugah selera.
            </p>

            <div class="flex flex-wrap gap-4">
                <a href="#menu" class="px-10 py-5 bg-[#4A3728] text-white rounded-2xl font-bold text-lg shadow-xl shadow-gray-900/20 hover:bg-[#E3C474] transition-all duration-300 transform hover:-translate-y-1">
                    Eksplor Menu
                </a>
                <div class="flex items-center gap-4 px-6 py-4 bg-white rounded-2xl border border-gray-100">
                    <div class="flex -space-x-3">
                        ...
                        <div class="w-10 h-10 rounded-full border-2 border-white bg-[#E3C474] flex items-center justify-center text-[10px] text-white font-bold">4.9</div>
                    </div>
        ...
        <div class="relative">
            <!-- Background Shape -->
            <div class="absolute inset-0 bg-gradient-to-tr from-[#E3C474] to-transparent opacity-20 blur-3xl rounded-full"></div>
