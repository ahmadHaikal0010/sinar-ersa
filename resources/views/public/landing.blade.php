...
<style>
    ...
    .handwritten-font {
        ...
        font-weight: 700; /* Dibuat sedikit tebal untuk judul */
        line-height: 1.2;
    }
...
<section class="bg-[#FFF8E7] py-20">
    <div class="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div class="flex justify-center">
            <img src="build/assets/img/tempe.jpg"
                 class="rounded-2xl w-96 shadow-xl object-cover">
        </div>
...
<section id="menu" class="py-20 bg-white">
    <div class="container mx-auto px-6 text-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            @php 
                $menus = [
                    ['img' => 'tempe.jpg', 'name' => 'Bakwan', 'price' => '25.000'],
                    ['img' => 'balado.jpg', 'name' => 'Ikan Balado', 'price' => '25.000'],
                    ['img' => 'pisang.jpeg', 'name' => 'Ketupat', 'price' => '25.000'],
                ];
            @endphp
            ...
            <div class="bg-white rounded-2xl border shadow hover:shadow-xl transition p-6">
                ...
                <div class="w-full h-48 rounded-xl overflow-hidden mb-4">
                    <img src="build/assets/img/{{ $m['img'] }}"
                         class="w-full h-full object-cover">
                </div>

                <h3 class="font-semibold text-xl text-gray-900">{{ $m['name'] }}</h3>
                <p class="text-gray-600 mb-3">Rp {{ $m['price'] }}</p>
                ...
                <div class="flex justify-center gap-4 mt-3">
                    ...
                    <button
                        class="px-4 py-2 bg-[#D9A84E] text-white rounded-lg hover:bg-[#c2903e] transition">
                        Beli
                    </button>
                </div>
...
<section class="py-20 bg-[#F4E8CF]">
    <div class="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div class="rounded-2xl overflow-hidden shadow-xl">
            <img src="build/assets/img/tentang.jpeg"class="object-cover w-full">
        </div>
        ...
        <div>
            ...
            <p class="text-gray-700 leading-relaxed text-sm mt-2">
                Dengan dua kategori utama - Oleh-Oleh dan Sarapan Pagi - kami berkomitmen untuk menghadirkan produk terbaik yang cocok untuk berbagai kebutuhan Anda. Pesan mudah lewat WhatsApp, kami siap melayani Anda dengan cepat dan ramah!
            </p>
        </div>
